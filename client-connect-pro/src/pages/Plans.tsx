...
const Plans = () => {
  ...
  const fetchPlans = async () => {
    ...
    const { data } = await supabase
      .from("plans")
      .select("*, code, panel_credentials:panel_credential_id(id, provider, label), plan_options(*)")
      .eq("user_id", user.id)
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        onChange={e => updateOption(idx, "duration_months", parseInt(e.target.value) || 1)}
                      />
                    </div>
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        onChange={e => updateOption(idx, "num_screens", parseInt(e.target.value) || 1)}
                      />
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                      ...
                      <Input
                        type="number" min="0" step="0.01" className="h-9"
                        value={opt.cost}
                        onChange={e => updateOption(idx, "cost", parseFloat(e.target.value) || 0)}
                      />
                    </div>
                  </div>
                </div>
